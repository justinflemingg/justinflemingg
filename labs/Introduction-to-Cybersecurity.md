# 🛡️ TryHackMe: Pre Security Path Walkthrough
...
* **Key Lab Activity:** Tasked wit the role of an ethical hacker and navigated a simulated web exploitation scenario to interact with data and see how an attacker targets an asset by using the provided terminal.
